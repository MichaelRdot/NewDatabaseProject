...
public class TrainerModel
{
    ...
    [JsonPropertyName("Classes_Teaching")]
    public ICollection<ClassModel> ClassesTeaching { get; } = new List<ClassModel>();
    ...
    [JsonPropertyName("Date_Started_Working")]
    public required string DateStartedWorking { get; set; } = string.Empty;
}